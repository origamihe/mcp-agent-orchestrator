    ...
    <div class="main-layout">
        ...
        <div class="main-content">
            ...
            <div class="feature-area">
                ...
                />
                <WebSearchPanel
                    v-else-if="activeFeature === 'web-search'"
                ...
                />
                <ExpertModePanel
                    v-else-if="activeFeature === 'expert-mode'"
                    ref="expertPanelRef"
                    :isConnected="isConnected"
                    :selectedModelId="selectedModelId"
                    @send-message="handleSendMessage"
...
import WebSearchPanel from '@/components/features/WebSearchPanel.vue'
import ExpertModePanel from '@/components/features/ExpertModePanel.vue'
...
const webSearchPanelRef = ref<any>(null)
const expertPanelRef = ref<any>(null)
...
watch(lastMessage, (msg) => {
    ...
    switch (activeFeature.value) {
        case 'chat':
            ...
            break
        case 'web-search':
            webSearchPanelRef.value?.addResult(msg)
            break
        case 'expert-mode':
            expertPanelRef.value?.addResult(msg)
            break
        case 'ppt-generator':
